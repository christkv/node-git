var sys = require('sys'),
  ...
  RawDeflate = require('zlib/rawdeflate').RawDeflate;
...
LooseStorage.prototype.put_raw_object = function(content, type) {
  ...
  try {
    ...
    // sys.puts(sys.inspect(RawDeflate.deflate.toString()))
    // var data = RawDeflate.deflate(store);
    // sys.puts("======================== data: " + data.length)
    // sys.puts(data)
    
    // sys.debug("=================================================================================")
    // sys.debug(store)
    // sys.debug("=================================================================================")
    // sys.debug(BinaryParser.hex(store))
    // sys.debug("=================================================================================")
    
    // TODODODODODODODODOD
    // TODODODODODODODODOD
    // FAILURE ON CURRENT LIBS, NEED TO Wrap my own    
