...
Git.prototype.git = function() {
  ...
  var arguments = args.length ? args.shift() : [];
...
Git.prototype.call_git = function(prefix, command, postfix, options, args, callback) {
  ...
  this.exec(call, { encoding: 'utf8', timeout: timeout, killSignal: 'SIGKILL'}, callback);
}

Git.prototype.exec = function(call, options, callback) {
...
Git.prototype.blame_tree = function(commit, path, callback) {
  ...
  file_index(this, function(err, file_index_instance) {
    ...
    self.rev_parse({}, commit, function(err, rev_parse_output) {
