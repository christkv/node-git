...
var Diff = exports.Diff = function(repo, a_path, b_path, a_blob, b_blob, a_mode, b_mode, new_file, deleted_file, diff) {  
  ...
  // Create blob objects
  var _a_blob = a_blob.match(/^0{40}$/) ? null : new Blob(repo, a_blob);
  var _b_blob = b_blob.match(/^0{40}$/) ? null : new Blob(repo, b_blob);
  // Chec if we have a new_file/deleted_file
  var _new_file = new_file || _a_blob;
  var _deleted_file = deleted_file || _b_blob;
