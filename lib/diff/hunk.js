...
var Hunk = exports.Hunk = function(data_old, data_new, piece, context, file_length_difference) {  
  // sys.puts("====================================== PIECE: " + sys.inspect(piece))
  ...
  // sys.puts("=========================== a2 || (b2 - after): " + (a2 || (b2 - after)))
  // sys.puts("=========================== b2 || (a2 + after): " + (b2 || (a2 + after)))
...
var unified_diff = function(hunk) {
  ...
  // sys.debug("++++++++++++++++++++++++++++++++++++++++ " + hunk.end_old.toString())
  // sys.debug("================================================ UNIFIED 3")
  ...
  // sys.puts("=================================================================== OUTLIST");
  // sys.puts(sys.inspect(outlist))
  
  // Process all the blocks
  hunk.blocks.forEach(function(block) {
    // sys.debug("================================================= PROCESS BLOCK");
    // sys.debug("=========== remove: " + sys.inspect(block.remove));
    // sys.debug("=========== insert: " + sys.inspect(block.insert));
    // 
  ...
  // sys.puts("========================================================== OUTLIST END")
  // sys.puts(sys.inspect(outlist))
  // sys.puts(outlist.join('\n'))
...
var unified_range = function(hunk, mode) {
  ...
  // sys.puts("======================================  hunk.end_old: " +  hunk.end_old)
  // sys.puts("======================================  hunk.end_new: " +  hunk.end_new)
  ...
  // sys.puts("=============================================== unified_range")
  // sys.puts("mode = " + mode)
  // sys.puts("s = " + s)
  // sys.puts("e = " + e)
  // sys.puts("length = " + length)
  // sys.puts("first = " + first)
